 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class th{constructor(e){this.fields=e,e.sort(K.comparator)}static empty(){return new th([])}unionWith(e){let t=new tu(K.comparator);for(let n of this.fields)t=t.add(n);for(let r of e)t=t.add(r);return new th(t.toArray())}covers(e){for(let t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return L(this.fields,e.fields,(e,t)=>e.isEqual(t))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class td{constructor(e){this.value=e}static empty(){return new td({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(!e$(t=(t.mapValue.fields||{})[e.get(n)]))return null;return(t=(t.mapValue.fields||{})[e.lastSegment()])||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=eQ(t)}setAll(e){let t=K.emptyPath(),n={},r=[];e.forEach((e,i)=>{if(!t.isImmediateParentOf(i)){let s=this.getFieldsMap(t);this.applyChanges(s,n,r),n={},r=[],t=i.popLast()}e?n[i.lastSegment()]=eQ(e):r.push(i.lastSegment())});let i=this.getFieldsMap(t);this.applyChanges(i,n,r)}delete(e){let t=this.field(e.popLast());e$(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return eF(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let r=t.mapValue.fields[e.get(n)];e$(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=r),t=r}return t.mapValue.fields}applyChanges(e,t,n){for(let r of(ew(t,(t,n)=>e[t]=n),n))delete e[r]}clone(){return new td(eQ(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class tm{constructor(e,t=null,n=[],r=[],i=null,s=null,a=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=r,this.limit=i,this.startAt=s,this.endAt=a,this.ft=null}}function tg(e,t=null,n=[],r=[],i=null,s=null,a=null){return new tm(e,t,n,r,i,s,a)}function tp(e){let t=e;if(null===t.ft){let n=t.path.canonicalString();null!==t.collectionGroup&&(n+="|cg:"+t.collectionGroup),n+="|f:",n+=t.filters.map(e=>(function e(t){if(t instanceof eJ)return t.field.canonicalString()+t.op.toString()+eq(t.value);if(e5(t))return t.filters.map(t=>e(t)).join(",");{let n=t.filters.map(t=>e(t)).join(",");return`${t.op}(${n})`}})(e)).join(","),n+="|ob:",n+=t.orderBy.map(e=>e.field.canonicalString()+e.dir).join(","),eI(t.limit)||(n+="|l:",n+=t.limit),t.startAt&&(n+="|lb:",n+=t.startAt.inclusive?"b:":"a:",n+=t.startAt.position.map(e=>eq(e)).join(",")),t.endAt&&(n+="|ub:",n+=t.endAt.inclusive?"a:":"b:",n+=t.endAt.position.map(e=>eq(e)).join(",")),t.ft=n}return t.ft}function ty(e,t){if(e.limit!==t.limit||e.orderBy.length!==t.orderBy.length)return!1;for(let n=0;n<e.orderBy.length;n++){var r,i;if(r=e.orderBy[n],i=t.orderBy[n],!(r.dir===i.dir&&r.field.isEqual(i.field)))return!1}if(e.filters.length!==t.filters.length)return!1;for(let s=0;s<e.filters.length;s++)if(!function e(t,n){return t instanceof eJ?n instanceof eJ&&t.op===n.op&&t.field.isEqual(n.field)&&eF(t.value,n.value):t instanceof e0?n instanceof e0&&t.op===n.op&&t.filters.length===n.filters.length&&t.filters.reduce((t,r,i)=>t&&e(r,n.filters[i]),!0):void b()}(e.filters[s],t.filters[s]))return!1;return e.collectionGroup===t.collectionGroup&&!!e.path.isEqual(t.path)&&!!eX(e.startAt,t.startAt)&&eX(e.endAt,t.endAt)}function tw(e){return G.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length}function tv(e,t){return e.filters.filter(e=>e instanceof eJ&&e.field.isEqual(t))}function tI(e,t,n){let r=eR,i=!0;for(let s of tv(e,t)){let a=eR,o=!0;switch(s.op){case"<":case"<=":var u;a="nullValue"in(u=s.value)?eR:"booleanValue"in u?{booleanValue:!1}:"integerValue"in u||"doubleValue"in u?{doubleValue:NaN}:"timestampValue"in u?{timestampValue:{seconds:Number.MIN_SAFE_INTEGER}}:"stringValue"in u?{stringValue:""}:"bytesValue"in u?{bytesValue:""}:"referenceValue"in u?eP(ep.empty(),G.empty()):"geoPointValue"in u?{geoPointValue:{latitude:-90,longitude:-180}}:"arrayValue"in u?{arrayValue:{}}:"mapValue"in u?{mapValue:{}}:b();break;case"==":case"in":case">=":a=s.value;break;case">":a=s.value,o=!1;break;case"!=":case"not-in":a=eR}0>ej({value:r,inclusive:i},{value:a,inclusive:o})&&(r=a,i=o)}if(null!==n){for(let l=0;l<e.orderBy.length;++l)if(e.orderBy[l].field.isEqual(t)){let c=n.position[l];0>ej({value:r,inclusive:i},{value:c,inclusive:n.inclusive})&&(r=c,i=n.inclusive);break}}return{value:r,inclusive:i}}function tb(e,t,n){let r=eA,i=!0;for(let s of tv(e,t)){let a=eA,o=!0;switch(s.op){case">=":case">":var u;a="nullValue"in(u=s.value)?{booleanValue:!1}:"booleanValue"in u?{doubleValue:NaN}:"integerValue"in u||"doubleValue"in u?{timestampValue:{seconds:Number.MIN_SAFE_INTEGER}}:"timestampValue"in u?{stringValue:""}:"stringValue"in u?{bytesValue:""}:"bytesValue"in u?eP(ep.empty(),G.empty()):"referenceValue"in u?{geoPointValue:{latitude:-90,longitude:-180}}:"geoPointValue"in u?{arrayValue:{}}:"arrayValue"in u?{mapValue:{}}:"mapValue"in u?eA:b(),o=!1;break;case"==":case"in":case"<=":a=s.value;break;case"<":a=s.value,o=!1;break;case"!=":case"not-in":a=eA}eW({value:r,inclusive:i},{value:a,inclusive:o})>0&&(r=a,i=o)}if(null!==n){for(let l=0;l<e.orderBy.length;++l)if(e.orderBy[l].field.isEqual(t)){let c=n.position[l];eW({value:r,inclusive:i},{value:c,inclusive:n.inclusive})>0&&(r=c,i=n.inclusive);break}}return{value:r,inclusive:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class tT{constructor(e,t=null,n=[],r=[],i=null,s="F",a=null,o=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=n,this.filters=r,this.limit=i,this.limitType=s,this.startAt=a,this.endAt=o,this.dt=null,this._t=null,this.startAt,this.endAt}}function tE(e){return new tT(e)}function tS(e){return 0===e.filters.length&&null===e.limit&&null==e.startAt&&null==e.endAt&&(0===e.explicitOrderBy.length||1===e.explicitOrderBy.length&&e.explicitOrderBy[0].field.isKeyField())}function tx(e){return e.explicitOrderBy.length>0?e.explicitOrderBy[0].field:null}function t_(e){for(let t of e.filters){let n=t.getFirstInequalityField();if(null!==n)return n}return null}function tD(e){return null!==e.collectionGroup}function tN(e){let t=e;if(null===t.dt){t.dt=[];let n=t_(t),r=tx(t);if(null!==n&&null===r)n.isKeyField()||t.dt.push(new ti(n)),t.dt.push(new ti(K.keyField(),"asc"));else{let i=!1;for(let s of t.explicitOrderBy)t.dt.push(s),s.field.isKeyField()&&(i=!0);if(!i){let a=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";t.dt.push(new ti(K.keyField(),a))}}}return t.dt}function tC(e){let t=e;if(!t._t){if("F"===t.limitType)t._t=tg(t.path,t.collectionGroup,tN(t),t.filters,t.limit,t.startAt,t.endAt);else{let n=[];for(let r of tN(t)){let i="desc"===r.dir?"asc":"desc";n.push(new ti(r.field,i))}let s=t.endAt?new eH(t.endAt.position,t.endAt.inclusive):null,a=t.startAt?new eH(t.startAt.position,t.startAt.inclusive):null;t._t=tg(t.path,t.collectionGroup,n,t.filters,t.limit,s,a)}}return t._t}function tk(e,t){t.getFirstInequalityField(),t_(e);let n=e.filters.concat([t]);return new tT(e.path,e.collectionGroup,e.explicitOrderBy.slice(),n,e.limit,e.limitType,e.startAt,e.endAt)}function tA(e,t,n){return new tT(e.path,e.collectionGroup,e.explicitOrderBy.slice(),e.filters.slice(),t,n,e.startAt,e.endAt)}function tR(e,t){return ty(tC(e),tC(t))&&e.limitType===t.limitType}function tV(e){return`${tp(tC(e))}|lt:${e.limitType}`}function tF(e){var t;let n;return`Query(target=${n=(t=tC(e)).path.canonicalString(),null!==t.collectionGroup&&(n+=" collectionGroup="+t.collectionGroup),t.filters.length>0&&(n+=`, filters: [${t.filters.map(e=>(function e(t){return t instanceof eJ?`${t.field.canonicalString()} ${t.op} ${eq(t.value)}`:t instanceof e0?t.op.toString()+" {"+t.getFilters().map(e).join(" ,")+"}":"Filter"})(e)).join(", ")}]`),eI(t.limit)||(n+=", limit: "+t.limit),t.orderBy.length>0&&(n+=`, orderBy: [${t.orderBy.map(e=>`${e.field.canonicalString()} (${e.dir})`).join(", ")}]`),t.startAt&&(n+=", startAt: ",n+=t.startAt.inclusive?"b:":"a:",n+=t.startAt.position.map(e=>eq(e)).join(",")),t.endAt&&(n+=", endAt: ",n+=t.endAt.inclusive?"a:":"b:",n+=t.endAt.position.map(e=>eq(e)).join(",")),`Target(${n})`}; limitType=${e.limitType})`}function tM(e,t){return t.isFoundDocument()&&function(e,t){let n=t.key.path;return null!==e.collectionGroup?t.key.hasCollectionId(e.collectionGroup)&&e.path.isPrefixOf(n):G.isDocumentKey(e.path)?e.path.isEqual(n):e.path.isImmediateParentOf(n)}(e,t)&&function(e,t){for(let n of tN(e))if(!n.field.isKeyField()&&null===t.data.field(n.field))return!1;return!0}(e,t)&&function(e,t){for(let n of e.filters)if(!n.matches(t))return!1;return!0}(e,t)&&(!e.startAt||!!function(e,t,n){let r=eY(e,t,n);return e.inclusive?r<=0:r<0}(e.startAt,tN(e),t))&&(!e.endAt||!!function(e,t,n){let r=eY(e,t,n);return e.inclusive?r>=0:r>0}(e.endAt,tN(e),t))}function tL(e){return e.collectionGroup||(e.path.length%2==1?e.path.lastSegment():e.path.get(e.path.length-2))}function tO(e){return(t,n)=>{let r=!1;for(let i of tN(e)){let s=function(e,t,n){let r=e.field.isKeyField()?G.comparator(t.key,n.key):function(e,t,n){let r=t.data.field(e),i=n.data.field(e);return null!==r&&null!==i?eL(r,i):b()}(e.field,t,n);switch(e.dir){case"asc":return r;case"desc":return -1*r;default:return b()}}(i,t,n);if(0!==s)return s;r=r||i.field.isKeyField()}return 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class tB{constructor(){this._=void 0}}function tK(e,t){return e instanceof tW?eU(t)||t&&"doubleValue"in t?t:{integerValue:0}:null}class tG extends tB{}class t$ extends tB{constructor(e){super(),this.elements=e}}function tQ(e,t){let n=tY(t);for(let r of e.elements)n.some(e=>eF(e,r))||n.push(r);return{arrayValue:{values:n}}}class tz extends tB{constructor(e){super(),this.elements=e}}function tj(e,t){let n=tY(t);for(let r of e.elements)n=n.filter(e=>!eF(e,r));return{arrayValue:{values:n}}}class tW extends tB{constructor(e,t){super(),this.yt=e,this.gt=t}}function tH(e){return eD(e.integerValue||e.doubleValue)}function tY(e){return eB(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ let rW=new Uint8Array(0);class rH{constructor(e,t){this.user=e,this.databaseId=t,this.Ye=new rj,this.Xe=new ns(e=>tp(e),(e,t)=>ty(e,t)),this.uid=e.uid||""}addToCollectionParentIndex(e,t){if(!this.Ye.has(t)){let n=t.lastSegment(),r=t.popLast();e.addOnCommittedListener(()=>{this.Ye.add(t)});let i={collectionId:n,parent:nH(r)};return rY(e).put(i)}return en.resolve()}getCollectionParents(e,t){let n=[],r=IDBKeyRange.bound([t,""],[t+"\0",""],!1,!0);return rY(e).W(r).next(e=>{for(let r of e){if(r.collectionId!==t)break;n.push(nY(r.parent))}return n})}addFieldIndex(e,t){let n=rZ(e),r={indexId:t.indexId,collectionGroup:t.collectionGroup,fields:t.fields.map(e=>[e.fieldPath.canonicalString(),e.kind])};delete r.indexId;let i=n.add(r);if(t.indexState){let s=rJ(e);return i.next(e=>{s.put(rS(e,this.user,t.indexState.sequenceNumber,t.indexState.offset))})}return i.next()}deleteFieldIndex(e,t){let n=rZ(e),r=rJ(e),i=rX(e);return n.delete(t.indexId).next(()=>r.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0))).next(()=>i.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0)))}getDocumentsMatchingTarget(e,t){let n=rX(e),r=!0,i=new Map;return en.forEach(this.Ze(t),t=>this.tn(e,t).next(e=>{r&&(r=!!e),i.set(t,e)})).next(()=>{if(r){let e=nf(),s=[];return en.forEach(i,(r,i)=>{y("IndexedDbIndexManager",`Using index id=${r.indexId}|cg=${r.collectionGroup}|f=${r.fields.map(e=>`${e.fieldPath}:${e.kind}`).join(",")} to execute ${tp(t)}`);let a=function(e,t){let n=Q(t);if(void 0===n)return null;for(let r of tv(e,n.fieldPath))switch(r.op){case"array-contains-any":return r.value.arrayValue.values||[];case"array-contains":return[r.value]}return null}(i,r),o=function(e,t){let n=new Map;for(let r of z(t))for(let i of tv(e,r.fieldPath))switch(i.op){case"==":case"in":n.set(r.fieldPath.canonicalString(),i.value);break;case"not-in":case"!=":return n.set(r.fieldPath.canonicalString(),i.value),Array.from(n.values())}return null}(i,r),u=function(e,t){let n=[],r=!0;for(let i of z(t)){let s=0===i.kind?tI(e,i.fieldPath,e.startAt):tb(e,i.fieldPath,e.startAt);n.push(s.value),r&&(r=s.inclusive)}return new eH(n,r)}(i,r),l=function(e,t){let n=[],r=!0;for(let i of z(t)){let s=0===i.kind?tb(e,i.fieldPath,e.endAt):tI(e,i.fieldPath,e.endAt);n.push(s.value),r&&(r=s.inclusive)}return new eH(n,r)}(i,r),c=this.en(r,i,u),h=this.en(r,i,l),d=this.nn(r,i,o),f=this.sn(r.indexId,a,c,u.inclusive,h,l.inclusive,d);return en.forEach(f,r=>n.J(r,t.limit).next(t=>{t.forEach(t=>{let n=G.fromSegments(t.documentKey);e.has(n)||(e=e.add(n),s.push(n))})}))}).next(()=>s)}return en.resolve(null)})}Ze(e){let t=this.Xe.get(e);return t||(t=0===e.filters.length?[e]:(function(e){if(0===e.getFilters().length)return[];let t=function e(t){if(t instanceof eJ||t instanceof e0||b(),t instanceof eJ)return t;if(1===t.filters.length)return e(t.filters[0]);let n=t.filters.map(t=>e(t)),r=e0.create(n,t.op);return rK(r=rQ(r))?r:(r instanceof e0||b(),e1(r)||b(),r.filters.length>1||b(),r.filters.reduce((e,t)=>rG(e,t)))}(/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function e(t){var n,r;if(t instanceof eJ||t instanceof e0||b(),t instanceof eJ){if(t instanceof tt){let i=(null===(r=null===(n=t.value.arrayValue)||void 0===n?void 0:n.values)||void 0===r?void 0:r.map(e=>eJ.create(t.field,"==",e)))||[];return e0.create(i,"or")}return t}let s=t.filters.map(t=>e(t));return e0.create(s,t.op)}(e));return rK(t)||b(),rU(t)||rB(t)?[t]:t.getFilters()})(e0.create(e.filters,"and")).map(t=>tg(e.path,e.collectionGroup,e.orderBy,t.getFilters(),e.limit,e.startAt,e.endAt)),this.Xe.set(e,t)),t}sn(e,t,n,r,i,s,a){let o=(null!=t?t.length:1)*Math.max(n.length,i.length),u=o/(null!=t?t.length:1),l=[];for(let c=0;c<o;++c){let h=t?this.rn(t[c/u]):rW,d=this.on(e,h,n[c%u],r),f=this.un(e,h,i[c%u],s),m=a.map(t=>this.on(e,h,t,!0));l.push(...this.createRange(d,f,m))}return l}on(e,t,n,r){let i=new rL(e,G.empty(),t,n);return r?i:i.Ue()}un(e,t,n,r){let i=new rL(e,G.empty(),t,n);return r?i.Ue():i}tn(e,t){let n=new rP(t),r=null!=t.collectionGroup?t.collectionGroup:t.path.lastSegment();return this.getFieldIndexes(e,r).next(e=>{let t=null;for(let r of e)n.je(r)&&(!t||r.fields.length>t.fields.length)&&(t=r);return t})}getIndexType(e,t){let n=2,r=this.Ze(t);return en.forEach(r,t=>this.tn(e,t).next(e=>{e?0!==n&&e.fields.length<function(e){let t=new tu(K.comparator),n=!1;for(let r of e.filters)for(let i of r.getFlattenedFilters())i.field.isKeyField()||("array-contains"===i.op||"array-contains-any"===i.op?n=!0:t=t.add(i.field));for(let s of e.orderBy)s.field.isKeyField()||(t=t.add(s.field));return t.size+(n?1:0)}(t)&&(n=1):n=0})).next(()=>null!==t.limit&&r.length>1&&2===n?1:n)}cn(e,t){let n=new rM;for(let r of z(e)){let i=t.data.field(r.fieldPath);if(null==i)return null;let s=n.qe(r.kind);rk.Ie.ue(i,s)}return n.Fe()}rn(e){let t=new rM;return rk.Ie.ue(e,t.qe(0)),t.Fe()}an(e,t){let n=new rM;return rk.Ie.ue(eP(this.databaseId,t),n.qe(function(e){let t=z(e);return 0===t.length?0:t[t.length-1].kind}(e))),n.Fe()}nn(e,t,n){if(null===n)return[];let r=[];r.push(new rM);let i=0;for(let s of z(e)){let a=n[i++];for(let o of r)if(this.hn(t,s.fieldPath)&&eB(a))r=this.ln(r,s,a);else{let u=o.qe(s.kind);rk.Ie.ue(a,u)}}return this.fn(r)}en(e,t,n){return this.nn(e,t,n.position)}fn(e){let t=[];for(let n=0;n<e.length;++n)t[n]=e[n].Fe();return t}ln(e,t,n){let r=[...e],i=[];for(let s of n.arrayValue.values||[])for(let a of r){let o=new rM;o.seed(a.Fe()),rk.Ie.ue(s,o.qe(t.kind)),i.push(o)}return i}hn(e,t){return!!e.filters.find(e=>e instanceof eJ&&e.field.isEqual(t)&&("in"===e.op||"not-in"===e.op))}getFieldIndexes(e,t){let n=rZ(e),r=rJ(e);return(t?n.W("collectionGroupIndex",IDBKeyRange.bound(t,t)):n.W()).next(e=>{let t=[];return en.forEach(e,e=>r.get([e.indexId,this.uid]).next(n=>{t.push(function(e,t){let n=t?new W(t.sequenceNumber,new X(ry(t.readTime),new G(nY(t.documentKey)),t.largestBatchId)):W.empty(),r=e.fields.map(([e,t])=>new j(K.fromServerFormat(e),t));return new $(e.indexId,e.collectionGroup,r,n)}(e,n))})).next(()=>t)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(e=>0===e.length?null:(e.sort((e,t)=>{let n=e.indexState.sequenceNumber-t.indexState.sequenceNumber;return 0!==n?n:M(e.collectionGroup,t.collectionGroup)}),e[0].collectionGroup))}updateCollectionGroup(e,t,n){let r=rZ(e),i=rJ(e);return this.dn(e).next(e=>r.W("collectionGroupIndex",IDBKeyRange.bound(t,t)).next(t=>en.forEach(t,t=>i.put(rS(t.indexId,this.user,e,n)))))}updateIndexEntries(e,t){let n=new Map;return en.forEach(t,(t,r)=>{let i=n.get(t.collectionGroup);return(i?en.resolve(i):this.getFieldIndexes(e,t.collectionGroup)).next(i=>(n.set(t.collectionGroup,i),en.forEach(i,n=>this._n(e,t,n).next(t=>{let i=this.wn(r,n);return t.isEqual(i)?en.resolve():this.mn(e,r,n,t,i)}))))})}gn(e,t,n,r){return rX(e).put({indexId:r.indexId,uid:this.uid,arrayValue:r.arrayValue,directionalValue:r.directionalValue,orderedDocumentKey:this.an(n,t.key),documentKey:t.key.path.toArray()})}yn(e,t,n,r){return rX(e).delete([r.indexId,this.uid,r.arrayValue,r.directionalValue,this.an(n,t.key),t.key.path.toArray()])}_n(e,t,n){let r=rX(e),i=new tu(rO);return r.Z({index:"documentKeyIndex",range:IDBKeyRange.only([n.indexId,this.uid,this.an(n,t)])},(e,r)=>{i=i.add(new rL(n.indexId,t,r.arrayValue,r.directionalValue))}).next(()=>i)}wn(e,t){let n=new tu(rO),r=this.cn(t,e);if(null==r)return n;let i=Q(t);if(null!=i){let s=e.data.field(i.fieldPath);if(eB(s))for(let a of s.arrayValue.values||[])n=n.add(new rL(t.indexId,e.key,this.rn(a),r))}else n=n.add(new rL(t.indexId,e.key,rW,r));return n}mn(e,t,n,r,i){y("IndexedDbIndexManager","Updating index entries for document '%s'",t.key);let s=[];return function(e,t,n,r,i){let s=e.getIterator(),a=t.getIterator(),o=tc(s),u=tc(a);for(;o||u;){let l=!1,c=!1;if(o&&u){let h=n(o,u);h<0?c=!0:h>0&&(l=!0)}else null!=o?c=!0:l=!0;l?(r(u),u=tc(a)):c?(i(o),o=tc(s)):(o=tc(s),u=tc(a))}}(r,i,rO,r=>{s.push(this.gn(e,t,n,r))},r=>{s.push(this.yn(e,t,n,r))}),en.waitFor(s)}dn(e){let t=1;return rJ(e).Z({index:"sequenceNumberIndex",reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(e,n,r)=>{r.done(),t=n.sequenceNumber+1}).next(()=>t)}createRange(e,t,n){n=n.sort((e,t)=>rO(e,t)).filter((e,t,n)=>!t||0!==rO(e,n[t-1]));let r=[];for(let i of(r.push(e),n)){let s=rO(i,e),a=rO(i,t);if(0===s)r[0]=e.Ue();else if(s>0&&a<0)r.push(i),r.push(i.Ue());else if(a>0)break}r.push(t);let o=[];for(let u=0;u<r.length;u+=2){if(this.pn(r[u],r[u+1]))return[];let l=[r[u].indexId,this.uid,r[u].arrayValue,r[u].directionalValue,rW,[]],c=[r[u+1].indexId,this.uid,r[u+1].arrayValue,r[u+1].directionalValue,rW,[]];o.push(IDBKeyRange.bound(l,c))}return o}pn(e,t){return rO(e,t)>0}getMinOffsetFromCollectionGroup(e,t){return this.getFieldIndexes(e,t).next(r0)}getMinOffset(e,t){return en.mapArray(this.Ze(t),t=>this.tn(e,t).next(e=>e||b())).next(r0)}}function rY(e){return ru(e,"collectionParents")}function rX(e){return ru(e,"indexEntries")}function rZ(e){return ru(e,"indexConfiguration")}function rJ(e){return ru(e,"indexState")}function r0(e){0!==e.length||b();let t=e[0].indexState.offset,n=t.largestBatchId;for(let r=1;r<e.length;r++){let i=e[r].indexState.offset;0>Z(i,t)&&(t=i),n<i.largestBatchId&&(n=i.largestBatchId)}return new X(t.readTime,t.documentKey,n)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function r5(e,t,n){let r=e.store("mutations"),i=e.store("documentMutations"),s=[],a=IDBKeyRange.only(n.batchId),o=0,u=r.Z({range:a},(e,t,n)=>(o++,n.delete()));s.push(u.next(()=>{1===o||b()}));let l=[];for(let c of n.mutations){var h,d;let f=(h=c.key.path,d=n.batchId,[t,nH(h),d]);s.push(i.delete(f)),l.push(c.key)}return en.waitFor(s).next(()=>l)}function r4(e){let t;if(!e)return 0;if(e.document)t=e.document;else if(e.unknownDocument)t=e.unknownDocument;else{if(!e.noDocument)throw b();t=e.noDocument}return JSON.stringify(t).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class iS{constructor(){this.overlays=new ts(G.comparator),this.es=new Map}getOverlay(e,t){return en.resolve(this.overlays.get(t))}getOverlays(e,t){let n=nc();return en.forEach(t,t=>this.getOverlay(e,t).next(e=>{null!==e&&n.set(t,e)})).next(()=>n)}saveOverlays(e,t,n){return n.forEach((n,r)=>{this.oe(e,t,r)}),en.resolve()}removeOverlaysForBatchId(e,t,n){let r=this.es.get(n);return void 0!==r&&(r.forEach(e=>this.overlays=this.overlays.remove(e)),this.es.delete(n)),en.resolve()}getOverlaysForCollection(e,t,n){let r=nc(),i=t.length+1,s=new G(t.child("")),a=this.overlays.getIteratorFrom(s);for(;a.hasNext();){let o=a.getNext().value,u=o.getKey();if(!t.isPrefixOf(u.path))break;u.path.length===i&&o.largestBatchId>n&&r.set(o.getKey(),o)}return en.resolve(r)}getOverlaysForCollectionGroup(e,t,n,r){let i=new ts((e,t)=>e-t),s=this.overlays.getIterator();for(;s.hasNext();){let a=s.getNext().value;if(a.getKey().getCollectionGroup()===t&&a.largestBatchId>n){let o=i.get(a.largestBatchId);null===o&&(o=nc(),i=i.insert(a.largestBatchId,o)),o.set(a.getKey(),a)}}let u=nc(),l=i.getIterator();for(;l.hasNext()&&(l.getNext().value.forEach((e,t)=>u.set(e,t)),!(u.size()>=r)););return en.resolve(u)}oe(e,t,n){let r=this.overlays.get(n.key);if(null!==r){let i=this.es.get(r.largestBatchId).delete(n.key);this.es.set(r.largestBatchId,i)}this.overlays=this.overlays.insert(n.key,new rh(t,n));let s=this.es.get(t);void 0===s&&(s=nf(),this.es.set(t,s)),this.es.set(t,s.add(n.key))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class iB{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.Si=n,this.Di=r}static Ci(e,t){let n=nf(),r=nf();for(let i of t.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:r=r.add(i.doc.key)}return new iB(e,t.fromCache,n,r)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class oE{constructor(e){this._byteString=e}static fromBase64String(e){try{return new oE(eS.fromBase64String(e))}catch(t){throw new S(E.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new oE(eS.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class o_{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new S(E.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new S(E.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return M(this._lat,e._lat)||M(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function uE(e){e=aP(e,aQ);let t=aP(e.firestore,oc);return oi(oh(t),e._key).then(n=>uO(t,e,n))}class uS extends ug{constructor(e){super(),this.firestore=e}convertBytes(e){return new oE(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new aQ(this.firestore,null,t)}}function ux(e){e=aP(e,aQ);let t=aP(e.firestore,oc),n=oh(t),r=new uS(t);return(function(e,t){let n=new x;return e.asyncQueue.enqueueAndForget(async()=>(async function(e,t,n){try{let r=await e.persistence.runTransaction("read document","readonly",n=>e.localDocuments.getDocument(n,t));r.isFoundDocument()?n.resolve(r):r.isNoDocument()?n.resolve(null):n.reject(new S(E.UNAVAILABLE,"Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"))}catch(s){let i=sK(s,`Failed to get document '${t} from cache`);n.reject(i)}})(await oe(e),t,n)),n.promise})(n,e._key).then(n=>new uv(t,r,e._key,n,new uw(null!==n&&n.hasLocalMutations,!0),e.converter))}function u_(e){e=aP(e,aQ);let t=aP(e.firestore,oc);return oi(oh(t),e._key,{source:"server"}).then(n=>uO(t,e,n))}function uD(e){e=aP(e,az);let t=aP(e.firestore,oc),n=oh(t),r=new uS(t);return o2(e._query),os(n,e._query).then(n=>new ub(t,r,e,n))}function uN(e){e=aP(e,az);let t=aP(e.firestore,oc),n=oh(t),r=new uS(t);return(function(e,t){let n=new x;return e.asyncQueue.enqueueAndForget(async()=>(async function(e,t,n){try{let r=await iH(e,t,!0),i=new s8(t,r.Hi),s=i.Wu(r.documents),a=i.applyChanges(s,!1);n.resolve(a.snapshot)}catch(u){let o=sK(u,`Failed to execute query '${t} against cache`);n.reject(o)}})(await oe(e),t,n)),n.promise})(n,e._query).then(n=>new ub(t,r,e,n))}function uC(e){e=aP(e,az);let t=aP(e.firestore,oc),n=oh(t),r=new uS(t);return os(n,e._query,{source:"server"}).then(n=>new ub(t,r,e,n))}function uk(e,t,n){e=aP(e,aQ);let r=aP(e.firestore,oc),i=up(e.converter,t,n);return uL(r,[oF(oV(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tJ.none())])}function uA(e,t,n,...r){let i;e=aP(e,aQ);let s=aP(e.firestore,oc),a=oV(s);return i="string"==typeof(t=(0,u.m9)(t))||t instanceof oS?oK(a,"updateDoc",e._key,t,n,r):oB(a,"updateDoc",e._key,t),uL(s,[i.toMutation(e._key,tJ.exists(!0))])}function uR(e){return uL(aP(e.firestore,oc),[new ne(e._key,tJ.none())])}function uV(e,t){let n=aP(e.firestore,oc),r=aY(e),i=up(e.converter,t);return uL(n,[oF(oV(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tJ.exists(!1))]).then(()=>r)}function uF(e,...t){var n,r,i;let s,a,o;e=(0,u.m9)(e);let l={includeMetadataChanges:!1},c=0;"object"!=typeof t[0]||oo(t[c])||(l=t[c],c++);let h={includeMetadataChanges:l.includeMetadataChanges};if(oo(t[c])){let d=t[c];t[c]=null===(n=d.next)||void 0===n?void 0:n.bind(d),t[c+1]=null===(r=d.error)||void 0===r?void 0:r.bind(d),t[c+2]=null===(i=d.complete)||void 0===i?void 0:i.bind(d)}if(e instanceof aQ)a=aP(e.firestore,oc),o=tE(e._key.path),s={next(n){t[c]&&t[c](uO(a,e,n))},error:t[c+1],complete:t[c+2]};else{let f=aP(e,az);a=aP(f.firestore,oc),o=f._query;let m=new uS(a);s={next(e){t[c]&&t[c](new ub(a,m,f,e))},error:t[c+1],complete:t[c+2]},o2(e._query)}return function(e,t,n,r){let i=new a0(r),s=new sJ(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>sW(await or(e),s)),()=>{i.bc(),e.asyncQueue.enqueueAndForget(async()=>sH(await or(e),s))}}(oh(a),o,h,s)}function uM(e,t){return function(e,t){let n=new a0(t);return e.asyncQueue.enqueueAndForget(async()=>{(await or(e)).Ru.add(n),n.next()}),()=>{n.bc(),e.asyncQueue.enqueueAndForget(async()=>(function(e,t){e.Ru.delete(t)})(await or(e),n))}}(oh(e=aP(e,oc)),oo(t)?t:{next:t})}function uL(e,t){return function(e,t){let n=new x;return e.asyncQueue.enqueueAndForget(async()=>ar(await on(e),t,n)),n.promise}(oh(e),t)}function uO(e,t,n){let r=n.docs.get(t._key),i=new uS(e);return new uv(e,i,t._key,r,new uw(n.hasPendingWrites,n.fromCache),t.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
